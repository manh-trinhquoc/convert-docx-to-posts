...
class Settings_Page extends Base {
	...
	public function add_plugin_admin_menu() {
		 ...
		 *
		 */
		\add_menu_page( \__( 'Convert Docx To Post Settings', CDTP_TEXTDOMAIN ), CDTP_NAME, 'manage_options', CDTP_TEXTDOMAIN, array( $this, 'display_plugin_admin_page' ), 'dashicons-hammer', 90 );
	}
