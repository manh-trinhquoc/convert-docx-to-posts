...
namespace Convert_Docx_To_Posts\Integrations\Widgets;
...
class My_Recent_Posts_Widget extends \WPH_Widget {
	...
	public function __construct() {
		$args = array(
			'label'       => \__( 'My Recent Posts Example', CDTP_TEXTDOMAIN ),
			'description' => \__( 'My Recent Posts Widget Description', CDTP_TEXTDOMAIN ),
			'slug'        => 'recent-posts',
		...
		$args[ 'fields' ] = array(
			...
			array(
				// Field name/label
				'name'     => \__( 'Title', CDTP_TEXTDOMAIN ),
				// Field description
				'desc'     => \__( 'Enter the widget title.', CDTP_TEXTDOMAIN ),
				// Field id
				'id'       => 'title',
				...
				'class'    => 'widefat',
				// Default value
				'std'      => \__( 'Recent Posts', CDTP_TEXTDOMAIN ),
				/**
			...
			// Taxonomy Field
			array(
				'name'  => \__( 'Taxonomy', CDTP_TEXTDOMAIN ),
				'desc'  => \__( 'Set the taxonomy.', CDTP_TEXTDOMAIN ),
				'id'    => 'taxonomy',
				'type'  => 'taxonomy',
				'class' => 'widefat',
			),
			// Taxonomy Field
			array(
				'name'     => \__( 'Taxonomy terms', CDTP_TEXTDOMAIN ),
				'desc'     => \__( 'Set the taxonomy terms.', CDTP_TEXTDOMAIN ),
				'id'       => 'taxonomyterm',
				'type'     => 'taxonomyterm',
				'taxonomy' => 'category',
				'class'    => 'widefat',
			...
			// Pages Field
			array(
				'name'  => \__( 'Pages', CDTP_TEXTDOMAIN ),
				'desc'  => \__( 'Set the page.', CDTP_TEXTDOMAIN ),
				'id'    => 'pages',
				'type'  => 'pages',
				'class' => 'widefat',
			),
			// Post type Field
			array(
				'name'     => \__( 'Post type', CDTP_TEXTDOMAIN ),
				'desc'     => \__( 'Set the post type.', CDTP_TEXTDOMAIN ),
				'id'       => 'posttype',
				'type'     => 'posttype',
				'posttype' => 'post',
				'class'    => 'widefat',
			...
			// Amount Field
			array(
				'name'     => \__( 'Amount', CDTP_TEXTDOMAIN ),
				'desc'     => \__( 'Select how many posts to show.', CDTP_TEXTDOMAIN ),
				'id'       => 'amount',
				'type'     => 'select',
				// Selectbox fields
				'fields'   => array(
					array(
						'name'  => \__( '1 Post', CDTP_TEXTDOMAIN ),
						'value' => '1',
					),
					array(
						'name'  => \__( '2 Posts', CDTP_TEXTDOMAIN ),
						'value' => '2',
					),
					array(
						'name'  => \__( '3 Posts', CDTP_TEXTDOMAIN ),
						'value' => '3',
					),
			...
			array(
				'name'   => \__( 'Output as list', CDTP_TEXTDOMAIN ),
				'desc'   => \__( 'Wraps posts with the <li> tag.', CDTP_TEXTDOMAIN ),
				'id'     => 'list',
				'type'   => 'checkbox',
				// Checked by default:
				'std'    => 1, // 0 or 1
	...
	public function initialize() {
		...
		'widgets_init',
		static function() {
			\register_widget( 'Convert_Docx_To_Posts\Integrations\Widgets\My_Recent_Posts_Widget' );
		}
		);
	}
