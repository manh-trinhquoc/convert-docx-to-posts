...
namespace Convert_Docx_To_Posts\Cli;
...
if ( \defined( 'WP_CLI' ) && WP_CLI ) {
	...
	class Example extends Base {
		...
		public function __construct() {
			\WP_CLI::add_command( 'cdtp_commandname', array( $this, 'command_example' ) );
		}
		...
		public function initialize() {
			if ( !\apply_filters( 'convert_docx_to_posts_cdtp_enqueue_admin_initialize', true ) ) {
				return;
			}
