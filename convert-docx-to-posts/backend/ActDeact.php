...
class ActDeact extends Base {
	...
	public function initialize() {
		...
		\register_activation_hook( CDTP_TEXTDOMAIN . '/' . CDTP_TEXTDOMAIN . '.php', array( self::class, 'activate' ) );
		\register_deactivation_hook( CDTP_TEXTDOMAIN . '/' . CDTP_TEXTDOMAIN . '.php', array( self::class, 'deactivate' ) );
	}
